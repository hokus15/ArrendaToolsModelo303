...
class GeneradorEjercicio2026(Modelo303Generador):
    """
    Implementación para generar el modelo 303 trimestral para arrendadores con IVA para el ejercicio 2026.
    """
    ...
    def _generar_dp303_01(self, datos: Modelo303Datos) -> str:
        ...
        # Identificación (1) - Sujeto pasivo con derecho a deducir pago a cuenta de entregas de gasolinas, gasóleos
        ...
        modelo += self._base_tipo_cuota_str(datos.base_imponible, 21.0, iva_devengado)
    ...
    def _generar_dp303_03(self, datos: Modelo303Datos) -> str:
        ...
        modelo += self._convertir_a_centimos_str(0.0)
        # Resultado - Pago a cuenta de entregas de gasolinas, gasóleos y biocarburantes posteriores a la ultimación del régimen de depósito
        # distinto del aduanero atribuible a la Administración del Estado
        # (Suma de la casilla 36 de todos los modelos 319 correspondientes a entregas incluidas en esta autoliquidación) [112]
        modelo += self._convertir_a_centimos_str(0.0)
    ...
    def _generar_dp303_04(self, datos: Modelo303Datos) -> str:
        ...
        modelo += self._convertir_a_centimos_str(datos.volumen_anual_operaciones)
